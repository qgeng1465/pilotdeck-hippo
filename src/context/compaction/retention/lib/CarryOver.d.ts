 ...
 * is on.
 */
export declare const CARRYOVER_BUDGET_SHARE = 0.25;
/** Whether carry-over priority is enabled for this process. Default: on. */
export declare function isCarryOverEnabled(): boolean;
/** True when a previous compaction kept this message verbatim. */
export declare function isHippoRetained(message: HippoMessage): boolean;
/**
 ...
 * asserts.
 */
export declare function withHippoRetainedMarker<I extends HippoMessage>(message: I): I;
